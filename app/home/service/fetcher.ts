...
export const changeActivityStatusAsManger = async (id: number, status: string, token: string) => {
...
export const changeActivityAsManager = async (id: number, body: any, token: string) => {
...
export const addExtraChiefEditor = (projectId: number, chiefEditorId: string, token: string) => {
	return fetch(`${URL}/projects/${projectId}/extraChiefEditors/${chiefEditorId}`, {
		method: "POST",
		headers: {
			Authorization: `Bearer ${token}`,
			"Content-Type": "application/json",
...
export const getAllExtraChiefEditorsByProjectId = (projectId: number, token: string) => {
	return fetch(`${URL}/users/chiefEditors/toAssignAsExtraToProject/${projectId}`, {
		headers: {
			Authorization: `Bearer ${token}`,
			"Content-Type": "application/json",
		},
...
export const deleteExtraChiefEditor = (projectId: number, chiefEditorId: string, token: string) => {
	return fetch(`${URL}/projects/${projectId}/extraChiefEditors/${chiefEditorId}`, {
		method: "DELETE",
		headers: {
			Authorization: `Bearer ${token}`,
